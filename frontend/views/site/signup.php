...
<!--            <input type='file' onchange="readURL(this);" />-->
        ...
        <li>
            ...
            )->dropDownList($list,['prompt'=>"Введіть назву програми в ІЛУ де ви навчалися"])->label(false) ?>
        ...
        <li>
            ...
            )->input('numeric',['placeholder'=>"Введіть рік випуску з ІЛУ", "min"=>2004])->label(false) ?>
